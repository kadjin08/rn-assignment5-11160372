...
<Image source={require('./assets/dous.jpg')} style={{ width: 40, height: 40, borderRadius: 100, margin: 10 }}></Image>
</View>

<View style={styles.welcome}>
<Text style={{fontSize: 21, fontWeight: 200}}>Welcome back, </Text>
<Text style={{fontSize: 22, fontWeight: 500}}>Karl Adjin</Text>
</View>
...
<View style={styles.activity}>
  <View>
  <TouchableOpacity style={{padding: 10, backgroundColor: 'whitesmoke', borderRadius: 50, marginBottom: 7, }}> 
